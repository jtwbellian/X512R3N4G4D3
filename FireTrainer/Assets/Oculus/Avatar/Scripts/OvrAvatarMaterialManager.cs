...
public class OvrAvatarMaterialManager : MonoBehaviour
{
    ...
    // Shader properties
    public static string AVATAR_SHADER_COMBINED = "Shader Graphs/shader_hands";
    public static string AVATAR_SHADER_LOADER = "Shader Graphs/shader_hands";
    public static string AVATAR_SHADER_MAINTEX = "Shader Graphs/shader_hands";
    public static string AVATAR_SHADER_NORMALMAP = "Shader Graphs/shader_hands";
    public static string AVATAR_SHADER_ROUGHNESSMAP = "Shader Graphs/shader_hands";
    public static string AVATAR_SHADER_COLOR = "Shader Graphs/shader_hands";
    public static string AVATAR_SHADER_DIFFUSEINTENSITY = "Shader Graphs/shader_hands";
    public static string AVATAR_SHADER_RIMINTENSITY = "Shader Graphs/shader_hands";
    public static string AVATAR_SHADER_BACKLIGHTINTENSITY = "Shader Graphs/shader_hands";
    public static string AVATAR_SHADER_REFLECTIONINTENSITY = "Shader Graphs/shader_hands";
    public static string AVATAR_SHADER_CUBEMAP = "Shader Graphs/shader_hands";
    public static string AVATAR_SHADER_ALPHA = "Shader Graphs/shader_hands";
    public static string AVATAR_SHADER_LOADING_DIMMER = "Shader Graphs/shader_hands";
